...
function Schedule({ dbSchedule, removeSchedule }: { dbSchedule: ruleSchedule, removeSchedule: () => void }) {
    ...
    return (
        <div className="schedules">
            ...
            <div className="buttonField">
                <Button sx={{color: "black", borderColor: "black", margin: "1em 0 0 0"}} startIcon={<LabelIcon />} variant="outlined">Apply Schedule</Button>
